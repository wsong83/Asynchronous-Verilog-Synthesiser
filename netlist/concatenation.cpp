...
void netlist::ConElem::scan_vars(NetComp::scan_var_type& svar, bool ctl) const {
  if(exp)
    exp->scan_vars(svar, ctl);
...
void netlist::Concatenation::scan_vars(scan_var_type& svar, bool ctl) const {
